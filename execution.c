...
/*   Updated: 2023/09/18 06:33:43 by araiteb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	checkrd(t_cmd *tmp, t_substruct *tmps, int **fds)
{
	while (tmps)
	{
...
void	one_built(t_varn *var, t_cmd *tmp, char **env)
{
	t_substruct	*tmps;
