...
/*   Updated: 2023/09/11 13:18:32 by araiteb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

// int	herd_rd_in(t_cmd *ls, t_substruct **cmd, char *str)
// {
// 	char *new = NULL;
...
// 	str = getLastCmd(prvcmd);
// 	if ((*cmd)->type == heredoc || (*cmd)->type == rd_input || str)
// 	{
// 		if(!herd_rd_in(ls, cmd, str))
// 			return(0);
// 		is_tr = 1;
// 	}
